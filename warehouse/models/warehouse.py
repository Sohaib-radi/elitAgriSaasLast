...
class Warehouse(FarmLinkedModel):
    ...
    space = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_("Total Space (m²)"))
    latitude = models.FloatField(null=True, blank=True, verbose_name=_("Latitude"))
    longitude = models.FloatField(null=True, blank=True, verbose_name=_("Longitude"))
    image = models.ImageField(upload_to="warehouses/images/", null=True, blank=True, verbose_name=_("Main Image"))
